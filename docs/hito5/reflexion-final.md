...
> **Borrador del equipo** — completar/ajustar con la experiencia real de cada uno antes de la entrega.
> Objetivo: ~1 página. "Qué aprendimos" y "qué haríamos distinto".
...
- **Testing como parte del desarrollo, no como un agregado.** Pasamos de 21 a 72 tests automatizados y
...
- **Implementar el control de roles (RBAC) antes.** El defecto crítico DEF-EXP-04 (un CLIENT accede a
  todo) muestra que dejamos la autorización para el final.
